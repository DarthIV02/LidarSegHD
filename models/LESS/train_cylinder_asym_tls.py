...
def main(args):
    ...
    tls_label_name = get_tls_label_name(dataset_config["label_mapping"])
    unique_label = np.asarray(sorted(list(tls_label_name.keys())))[1:] - 1
    unique_label_str = [tls_label_name[x] for x in unique_label + 1]
