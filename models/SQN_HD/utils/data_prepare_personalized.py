...
data_config = os.path.join(BASE_DIR, 'semantic-tls.yaml')
...
grid_size = 0.06
#print(DP.get_dataset_root_path())
dataset_path = '/root/dataset/dense_dataset_numpy/sequences' # <--- CHANGE HERE
...
for seq_id in seq_list:
    ...
    if seq_id != "01":
        ...
        for scan_id in scan_list:
            ...
            labels = DP.load_label_kitti(join(label_path, str(scan_id[:-8]) + '.label.npy'), remap_lut)
